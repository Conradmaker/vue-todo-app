    ...
    <div :class='{done}' class="todo-item">
        ...
        <div v-if='isEditMode' class="item__inner item--edit">
            ...
            <div class="item__actions">
                <button class='btn btn--primary' key='finish' @click='editedTodo'><i class='material-icons'>done</i></button>
        ...
        <div v-else class="item__inner item--normal">
            <label><input type="checkbox" v-model="done"> <span class='icon'><i class="material-icons">check</i></span></label>
            ...
            <div class='item__actions'>
                ...
                <button class='btn btn--danger' key='delete' @click="deleteTodo"><i class='material-icons'>delete</i></button>
            </div>
        </div>
    </div>
</template>
